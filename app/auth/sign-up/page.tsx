        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h1 className="text-2xl font-bold">Agentic Meme Generator</h1>
            </div>
            <p className="text-sm text-muted-foreground">Create your account to start generating viral memes!</p>
          </div>
