...
CREATE POLICY "Users can insert their own generations" ON meme_generations 
  FOR INSERT WITH CHECK (auth.uid() = user_id OR user_id IS NULL);

CREATE POLICY "Users can update their own generations" ON meme_generations 
  FOR UPDATE USING (auth.uid() = user_id OR user_id IS NULL);

CREATE POLICY "Users can delete their own generations" ON meme_generations 
